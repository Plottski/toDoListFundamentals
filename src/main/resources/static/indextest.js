...
function navBarDash() {
    ...
    $(document).ready(function () {
        $.get('/get-lists', function(data) {
            ...
            //dropDownListLink.setAttribute('href','#');
           // dropDownListLink.addEventListener('click', function (event) {
           //     event.preventDefault();
           //     dropDownListLink.setAttribute('aria-expanded', 'true');
           // })
    ...
    $(document).ready(function () {
        $.get('/get-lists', function (data) {
            ...
            createNewListButton.addEventListener('click', function (event) {
                ...
                mainContainer.appendChild(createNewListButton);
